								...
								<div class="row">
									...
									<div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
										<div class="form-group label-floating">
											...
											<input type="text" class="form-control" name="modelo" autocomplete="off" value="{{ old('modelo') }}">
										</div>
									</div>
								...
								<div class="row">
									<div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
										<div class="form-group label-floating">
											...
											<select class="form-control" name="marca" id="marca"autocomplete="off" value="{{ old('marca') }}" required>
												@foreach($marca as $mc)
									...
									<div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
										<div class="form-group label-floating">
											...
											<select class="form-control" name="tipo_vehiculo"id="tipo_vehiculo" autocomplete="off" value="{{ old('tipo_vehiculo') }}" required>
