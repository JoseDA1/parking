						...
						<form method="POST" action="{{ route('registros.store') }}">
							...
							<div class="card-body">
								<div class="row">
									<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
										<div class="form-group label-floating">
											...
											<select class="form-control" name="cliente" autocomplete="off" value="{{ old('cliente') }}" required>
								...
								<div class="row">
									<div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
										<div class="form-group label-floating">
											...
											<select class="form-control" name="bahia" autocomplete="off" value="{{ old('bahia') }}" required>
												@foreach($bahia as $bh)
									...
									<div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
										<div class="form-group label-floating">
											...
											<select class="form-control" name="vehiculo" autocomplete="off" value="{{ old('vehiculo') }}" required>
								...
								<div class="row">
									<div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
										<div class="form-group label-floating">
											<label class="control-label">Ingreso <strong style="color:red;">(*)</strong></label>
											<input type="datetime-local" class="form-control" name="fecha_ingreso" autocomplete="off" value="{{ old('fecha_ingreso') }}">
										</div>
									</div>
									<div class="col-lg-6 col-sm-6 col-md-6 col-xs-6">
										<div class="form-group label-floating">
											<label class="control-label">Salida <strong style="color:red;">(*)</strong></label>
											<input type="datetime-local" class="form-control" name="fecha_salida" autocomplete="off" value="{{ old('fecha_salida') }}">
										</div>
									</div>
								</div>
